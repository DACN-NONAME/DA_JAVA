        ...
        <div class="sidebar">
            ...
            <ul class="sidebar__nav">
                <li class="sidebar__nav-item">
                    <a href="index.html" class="sidebar__nav-link sidebar__nav-link--active"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                                  viewBox="0 0 24 24">
                        <path
                ...
                <li class="sidebar__nav-item">
                    <a href="catalog.html" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
                ...
                <li class="sidebar__nav-item">
                    <a href="comments.html" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
                ...
                <li class="dropdown sidebar__nav-item">
                    <a class="dropdown-toggle sidebar__nav-link" href="#" role="button" id="dropdownMenuMore" data-toggle="dropdown"
            ...
            <!-- sidebar copyright -->
            <div class="sidebar__copyright">© FlixGo, 2018—2022. <br>Create by <a
                    href="https://themeforest.net/user/dmitryvolkov/portfolio" rel="nofollow" target="_blank" rel="noopener">Dmitry
                    Volkov</a>.</div>
