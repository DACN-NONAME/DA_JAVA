                    ...
                    <table class="main__table">
                        ...
                        <tbody>
                            <c:forEach items="${tickets}" var="ticket">
                                <tr>
                                    <td>
                                        <div class="main__table-text">${ticket.id}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${ticket.type}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${ticket.price}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-btns">
                                            <a href="<c:url value="/admin/ticket?id=${ticket.id}" />" class="main__table-btn main__table-btn--edit">
