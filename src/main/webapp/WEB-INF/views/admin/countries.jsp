                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="main__table-btns">
                                            ...
                                            <a href="#modal-delete" onclick="setDeleteCountry(${country.id})" class="main__table-btn main__table-btn--delete open-modal">
...
<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
    ...
    <div class="modal__btns">
        <button class="modal__btn modal__btn--apply" type="button" onclick="deleteCountry()">Xoá</button>
