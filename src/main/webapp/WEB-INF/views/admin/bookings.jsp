                    ...
                    <table class="main__table">
                        ...
                        <tbody>
                            <c:forEach items="${bookings}" var="booking">
                                <tr>
                                    <td>
                                        <div class="main__table-text">${booking.id}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${booking.user_full_name}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${booking.film_name}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${booking.schedule_start_time}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${booking.created_at}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-btns">
                                            <a href="<c:url value="/admin/booking?id=${booking.id}" />" class="main__table-btn main__table-btn--view">
