        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="main__title">
                    ...
                    <a href="<c:url value="/admin/category" />" class="main__title-link">Thêm mới</a>
                </div>
            </div>
            <!-- end main title -->
            <!-- users -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="main__table-btns">
                                            <a href="<c:url value="/admin/category?id=${category.id}" />" class="main__table-btn main__table-btn--edit">
                                            ...
                                            <a href="#modal-delete" onclick="setDeleteItem(${category.id})" class="main__table-btn main__table-btn--delete open-modal">
...
<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
    ...
    <div class="modal__btns">
        <button class="modal__btn modal__btn--apply" type="button" onclick="deleteItem('<c:url value="/admin/category/delete?id=" />' + item_id, '<c:url value="/admin/categories" />')">Xoá</button>
