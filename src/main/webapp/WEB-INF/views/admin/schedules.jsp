                    ...
                    <table class="main__table">
                        ...
                        <tbody>
                            <c:forEach items="${schedules}" var="schedule">
                                <tr>
                                    <td>
                                        <div class="main__table-text">${schedule.id}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${schedule.film_name}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${schedule.cinema_name}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${schedule.room_name}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-text">${schedule.start_time}</div>
                                    </td>
                                    <td>
                                        <div class="main__table-btns">
                                            <a href="<c:url value="/admin/schedule?id=${schedule.id}" />" class="main__table-btn main__table-btn--edit">
                                            ...
                                            <a href="#modal-delete" onclick="setDeleteItem(${schedule.id})" class="main__table-btn main__table-btn--delete open-modal">
...
<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
    ...
    <div class="modal__btns">
        <button class="modal__btn modal__btn--apply" type="button" onclick="deleteItem('<c:url value="/admin/schedule/delete?id=" />' + item_id, '<c:url value="/admin/schedules" />')">Xoá</button>
