...
public class Film {
    ...
    /**
     * @param rated_id the rated_id to set
     */
    ...
    /**
     * @return the rated_name
     */
    public String getRated_name() {
        return rated_name;
    }

    /**
     * @param rated_name the rated_name to set
     */
    public void setRated_name(String rated_name) {
        this.rated_name = rated_name;
    }
